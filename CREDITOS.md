...
- **Factory Kit**: esteiras, divisor, juntador, máquinas, scanner, funil, computador, piso, engrenagem, Oopi, válvula do irrigador, cone (chapéu do Oopi), braço robótico. https://kenney.nl/assets/factory-kit
...
- **Rain Loopable**, por Ylmir: https://opengameart.org/content/rain-loopable

## Músicas, Kevin MacLeod (incompetech.com)
Licenciadas sob **Creative Commons: By Attribution 4.0**, http://creativecommons.org/licenses/by/4.0/

**Bossa FM:** "Bossa Antigua", "Casa Bossa Nova", "BossaBossa", "Samba Isobel", "Cool Vibes", "Sidewalk Shade", "Latin Industries", "Airport Lounge"

**Lo-fi Chill:** "Lobby Time", "Wallpaper", "Dreamer", "Deliberate Thought", "Carefree", "Easy Lemon"

**Jazz Lounge:** "Jazz Brunch", "Smooth Lovin", "Hep Cats", "Bass Walker", "George Street Shuffle", "Local Forecast - Elevator", "Laid Back Guitars"

## Músicas, OpenGameArt.org (CC0)
- **Bossa Town**, por KarateStudios: https://opengameart.org/content/bossa-town
- **Bossa Shop Theme (HD)**, por SpringySpringo: https://opengameart.org/content/bossa-shop-theme-in-low-fi-and-hd
- **Bossa Nova (8-bit)**, por Joth: https://opengameart.org/content/bossa-nova

## Céu e texturas, Poly Haven (CC0)
- HDRI **Kloofendal 48d Partly Cloudy (Pure Sky)**: https://polyhaven.com/a/kloofendal_48d_partly_cloudy_puresky
- Textura **Aerial Grass Rock**: https://polyhaven.com/a/aerial_grass_rock

## Fontes (SIL Open Font License), via Fontsource
- **Chakra Petch**: https://fontsource.org/fonts/chakra-petch
- **Space Grotesk**: https://fontsource.org/fonts/space-grotesk
- **JetBrains Mono**: https://fontsource.org/fonts/jetbrains-mono

## Motor 3D
- **three.js** r169 (licença MIT): https://threejs.org
